...
// phpcs:disable WordPress.WP.AlternativeFunctions -- F is a self-contained filesystem helper for plugin-internal files (bundled data + cache); direct PHP file operations are its whole purpose.
	...
	public static function save( $filename, $data, $mkdir = false, $append = false, $silence = true ) {
		...
		if ( ! file_exists( $folder ) ) {
			...
			try {
				...
				/* translators: %1$s: the folder path; %2$s: the underlying error message. */
